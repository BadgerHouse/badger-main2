...
const texts = {
  tr: {
    title: "Badger Görsel Prodüksiyon",
    services: [
      "Etkileşimli enstalasyonlar & Projection mapping",
      "CGI/3D Billboard içerikleri",
      "AR/VR Projeleri",
      "Etkinlik görselleri & LED ekran içerikleri"
    ],
  ...
  en: {
    title: "Badger Visual Production",
    services: [
      "Interactive Installations & Projection Mapping",
      "CGI/3D Billboard Content",
      "AR/VR Projects",
      "Event Visuals & LED Screen Content"
    ],
...
export default function VisualDepartment() {
